...
class PostForm(forms.ModelForm):
    class Meta:
        model = Post
        fields = ['title', 'content', 'category', 'accommodation_name', 'travel_destination', 'image']
        widgets = {
            ...
            'accommodation_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '숙소 이름을 입력하세요'}),
            'travel_destination': forms.TextInput(attrs={'class': 'form-control', 'placeholder': '여행지를 입력하세요'}),
    ...
    accommodation_name = forms.CharField(
        required=False, 
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '숙소 이름을 입력하세요'}),
        label='숙소 이름'
    )
    travel_destination = forms.CharField(
        required=False, 
        widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': '여행지를 입력하세요'}),
        label='여행지'
    )
